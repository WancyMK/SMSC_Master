...
public class SMSC_DashBoard_PageObjects {
    ...
    public static final By Bar_Chart_Element = By.xpath("//div[@class='barChart']//div[@class='recharts-wrapper']//*[name()='svg']");
    public static final By X_Axis_Element = By.xpath("//div[@class='barChart']//div[@class='recharts-wrapper']//*[name()='svg'][1]/*[name()='g'][2]");
}
