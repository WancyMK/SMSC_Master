...
public class smsc_DashBoard extends SMSC_Base {
    ...
    public void the_bar_and_pie_charts_should_be_visible_with_proper_formatting() throws Throwable {
        SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.Select_channel, 10);
        SMSC_Actions.selectByVisibleText(smsc_DashBoard_Objects.Select_channel, "simulator-telecom");
...
//            System.out.println("Bar and Pie charts are visible with proper formatting.");
    ...
    public void the_bar_chart_should_show_time_intervals_on_the_x_axis() throws InterruptedException {
        SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.Axis_Interval, 10);
        SMSC_Actions.getElementText(smsc_DashBoard_Objects.Axis_Interval);
        Thread.sleep(3000);
    ...
    public void the_pie_chart_should_display_statuses() {
        SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.Piechart_errors, 10);
        SMSC_Actions.clickViaMouse(smsc_DashBoard_Objects.Piechart_errors, "Queued");
    ...
    public void the_user_checks_the_visual_elements_of_the_dashboard() throws InterruptedException {
        Thread.sleep(3000);
        SMSC_Actions.waitForElementTextToBePresent(driver, smsc_DashBoard_Objects.barcart_container, 10, "Total Transactions:");
        SMSC_Actions.waitForElementTextToBePresent(driver, smsc_DashBoard_Objects.Monitor_Message, 5, "Monitor Messages");
        SMSC_Actions.waitForElementTextToBePresent(driver, smsc_DashBoard_Objects.Total_Transactions, 5, "Monitor Transactions for Last 24hr");
        SMSC_Actions.waitForElementTextToBePresent(driver, smsc_DashBoard_Objects.TotalMessages_Count, 5, "61");
...
//        	Assert.assertTrue("Text did not appear as expected!", isTextPresent);
    ...
    public void all_visual_elements_should_be_accurately_displayed_according_to_the_design_specifications() {
        ...
        SMSC_Actions.clickViaMouse(smsc_DashBoard_Objects.DashBoard_Head, "Dasboard");
        SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.Total_Transactions, 10);
        SMSC_Actions.getElementText(smsc_DashBoard_Objects.Total_Transactions);
    ...
    public void data_is_available_for_the_selected_channel() {
        SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.Select_channel, 10);
        SMSC_Actions.clickViaMouse(smsc_DashBoard_Objects.Select_channel, "Selected Channel");
    ...
    public void the_user_compares_the_chart_data_against_the_actual_data() {
        SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.Chart_Element, 10);

        // Wait for the actual data element to be visible
       // SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.Actual_Data_Element, 10);

        // Get the chart data (this method should be implemented to extract chart data)
        String chartData = SMSC_Actions.getElementText(smsc_DashBoard_Objects.Chart_Element);

        // Get the actual data (this method should be implemented to extract actual data)
        String actualData = SMSC_Actions.getElementText(smsc_DashBoard_Objects.Actual_Data_Element);
    ...
    public void the_bar_and_pie_charts_should_correctly_represent_the_data() {
        SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.Bar_Chart_Element, 10);
        SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.Pie_Chart_Element, 10);

        // Get data from Bar and Pie charts
        String barChartData = SMSC_Actions.getText(smsc_DashBoard_Objects.Bar_Chart_Element);
        String pieChartData = SMSC_Actions.getText(smsc_DashBoard_Objects.Pie_Chart_Element);
    ...
    public void the_user_checks_the_time_intervals_on_the_x_axis() {
        SMSC_Actions.waitForElementToBeVisible(smsc_DashBoard_Objects.X_Axis_Element, 10);

        // Get the time interval elements on the X-axis (this could be a list of text or attribute values)
        List<String> xAxisIntervals = SMSC_Actions.getText(smsc_DashBoard_Objects.X_Axis_Time_Intervals);
