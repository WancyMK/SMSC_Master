...
public class SMSC_Messages extends SMSC_Base {
    ...
    public void user_clicks_on_messages_on_the_sidebar() {
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.messagesSidebar_btn, 45);
        SMSC_Actions.jsClickOnElement(SMSC_Messages_PageObjects.messagesSidebar_btn, "Messages");

        recipientText = SMSC_Actions.getText(SMSC_Messages_PageObjects.recipient_txt, "Recipient");
        transactionIDText = SMSC_Actions.getText(SMSC_Messages_PageObjects.transactionID_txt, "Transaction ID");
    ...
    public void user_validates_the_valid_search_results_on_messages_page() throws InterruptedException {
        ...
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.transactionID_txt, 50);
        String fetchedTransactionIDText = SMSC_Actions.getText(SMSC_Messages_PageObjects.transactionID_txt, "Transaction ID");
    ...
    public void user_validates_the_error_message_as_on_messages_page(String string) {
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.noMessagesFound_txt, 45);
    ...
    public void user_selects_recipient_from_the_filters_dropdown() throws Exception {
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.search_dropdown, 45);
        SMSC_Actions.ClickViaMouse(SMSC_Messages_PageObjects.search_dropdown,"Search dropdown");
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.recipientOption_dropdown, 45);
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.recipientOption_dropdown, 45);
    ...
    public void user_validates_the_recipient_search_results() throws InterruptedException {
        Thread.sleep(3000);
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.recipient_txt, 50);
        String recipientSearch = SMSC_Actions.getText(SMSC_Messages_PageObjects.recipient_txt, "Recipient");
    ...
    public void user_selects_transaction_from_the_filters_dropdown() throws Exception {
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.search_dropdown, 45);
        SMSC_Actions.ClickViaMouse(SMSC_Messages_PageObjects.search_dropdown,"Search dropdown");
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.transactionOption_dropdown, 45);
    ...
    public void user_validates_the_transaction_id_search_results() throws InterruptedException {
        ...
        SMSC_Actions.waitForTextChangeFluently(SMSC_Messages_PageObjects.transactionID_txt, "No messages found.", 50, 3);
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.transactionID_txt, 50);
        String transactionSearch = SMSC_Actions.getText(SMSC_Messages_PageObjects.transactionID_txt, "Transaction ID");
    ...
    public void user_selects_channel_from_the_filters_dropdown() throws Exception {
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.search_dropdown, 45);
        SMSC_Actions.ClickViaMouse(SMSC_Messages_PageObjects.search_dropdown,"Search dropdown");
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.channelOption_dropdown, 45);
    ...
    public void user_validates_the_channel_search_results() throws InterruptedException {
        Thread.sleep(3000);
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.channel_txt, 50);
        String channelSearch = SMSC_Actions.getText(SMSC_Messages_PageObjects.channel_txt, "Channel");
    ...
    public void user_clicks_on_view_button() throws Exception {
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.view_btn, 45);
    ...
    public void user_validates_message_details() {
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.validateMessageDetails_txt, 45);
        ...
        SMSC_Actions.waitForElement(SMSC_Messages_PageObjects.close_btn, 45);
