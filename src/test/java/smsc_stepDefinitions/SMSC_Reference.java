...
public class SMSC_Reference extends SMSC_Base {
    ...
    public void user_clicks_on_references_on_the_side_bar() {
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.referencesSideBar_btn, 10);
    ...
    public void user_clicks_on_create_new_reference_button() {
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.createNewReference_btn, 10);
    ...
    public void user_enters_reference_name_as_on_new_reference_page(String string) {
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.referenceName_txtb, 10);
    ...
    public void user_enters_reference_as_on_new_reference_page(String string) {
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.reference_txtb, 10);
    ...
    public void user_selects_party_type_as_on_new_reference_page(String string) throws Exception {
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.partyType_dropdown, 10);
        SMSC_Actions.ClickViaMouse(SMSC_References_PageObjects.partyType_dropdown, "Party Type");
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.partyTypeOption_dropdown, 10);
    ...
    public void user_enters_email_address_as_on_new_reference_page(String string) {
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.emailAddress_txtb, 10);
    ...
    public void user_enters_contact_number_as_on_new_reference_page(String string) {
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.contactNumber_txtb, 10);
    ...
    public void user_enters_description_as_on_new_reference_page(String string) {
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.description_txtb, 10);
    ...
    public void user_should_see_error_messages_for_all_the_reference_mandatory_fields() {
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.errorReferenceName_txt, 10);
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.errorReference_txt, 10);
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.errorPartyType_txt, 10);
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.errorEmailAddress_txt, 10);
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.errorContactNumber_txt, 10);
        ...
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.errorDescription_txt, 10);
    ...
    public void user_validates_the_valid_search_results_on_references_page() {
        String searchContent = SMSC_Utils.ConfigReader.getProperty("referenceName");
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.validateReferenceCreated_txt, 10);
        String searchResults = SMSC_Actions.getText(SMSC_References_PageObjects.validateReferenceCreated_txt, "Search validate");
    ...
    public void user_validates_the_error_message_as_on_references_page(String string) {
        SMSC_Actions.waitForElement(SMSC_References_PageObjects.searchErrorMessage, 10);
