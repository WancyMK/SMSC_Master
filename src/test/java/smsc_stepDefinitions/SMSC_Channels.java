...
public class SMSC_Channels extends SMSC_Base{
    ...
    public void user_clicks_on_channels_on_the_side_bar() {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.channelSideBar_btn, 10);
    ...
    public void user_clicks_on_create_new_channel_button() {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.createNewChannel_btn, 10);
    ...
    public void user_enters_host_as_on_new_channel_page(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.host_txtb, 10);
    ...
    public void user_enters_port_as_on_new_channel_page(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.port_txtb, 10);
    ...
    public void user_enters_system_id_as_on_new_channel_page(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.systemID_txtb, 20);
    ...
    public void user_enters_password_as_on_new_channel_page(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.password_txtb, 10);
    ...
    public void user_enters_service_type_as_on_new_channel_page(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.serviceType_txtb, 10);
    ...
    public void user_enters_priority_as_on_new_channel_page(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.priority_txtb, 10);
    ...
    public void user_enters_source_address_as_on_new_channel_page(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.sourceAddress_txtb, 10);
    ...
    public void user_selects_status_as_on_new_channel_page(String string) {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.status_dropdown, 10);
        SMSC_Actions.clickOnElement(SMSC_Channels_PageObjects.status_dropdown, "Status dropdown");
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.statusActiveOption_dropdown, 10);
    ...
    public void user_enters_provider_as_on_new_channel_page(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.provider_txtb, 10);
    ...
    public void user_selects_multi_for_bulk_as_on_new_channel_page(String string) throws Exception {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.multiForBulk_dropdown, 10);
        SMSC_Actions.ClickViaMouse(SMSC_Channels_PageObjects.multiForBulk_dropdown, "Multi For Bulk dropdown");
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.multiForBulkOption_dropdown, 10);
    ...
    public void user_enters_filters_as_on_new_channel_page(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.filters_txtb, 10);
    ...
    public void user_verifies_the_created_channel_to_validate_channel_is_created() throws Exception {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.validateChannelCreated_txt, 10);
    ...
    public void user_clicks_on_cancel_button() {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.cancel_btn, 10);
    ...
    public void user_clicks_on_create_button_to_validate_mandatory_fields_of_new_channel() {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.create_btn, 20);
        SMSC_Actions.jsClickOnElement(SMSC_Channels_PageObjects.create_btn, "Create Button");
    }
    ...
    public void User_should_see_an_error_message_for_all_the_channel_mandatory_fields() {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorChannelName_txt, 10);
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorHost_txt, 10);
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorPort_txt, 10);
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorSystemID_txt, 10);
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorPassword_txt, 10);
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorServiceType_txt, 10);
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorPriority_txt, 10);
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorSourceAddress_txt, 10);
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorProvider_txt, 10);
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.errorFilters_txt, 10);
    ...
    public void user_updates_the_provider_field_as(String string) {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.provider_txtb, 20);
    ...
    public void user_clicks_on_update_button() {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.update_btn, 10);
    ...
    public void user_selects_the_status_as(String string) {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.status_dropdown, 10);
        SMSC_Actions.clickOnElement(SMSC_Channels_PageObjects.status_dropdown, "Status dropdown");
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.statusInactiveOption_dropdown, 10);
    ...
    public void user_clicks_on_update_button_and_validates_whether_the_channel_is_updated_as_inactive() {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.search_txtb, 10);
        SMSC_Actions.typeInTextBox(SMSC_Channels_PageObjects.search_txtb, text, "Search Box");
        String statusfetchedText = SMSC_Actions.getElementText(SMSC_Channels_PageObjects.status_txt, "Status updated text");
    ...
    public void user_validates_the_valid_search_results_on_channels_page() {
        String searchContent = SMSC_Utils.ConfigReader.getProperty("channelName");
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.validateChannelCreated_txt, 10);
        String searchResults = SMSC_Actions.getElementText(SMSC_Channels_PageObjects.validateChannelCreated_txt, "Search validate");
    ...
    public void user_validates_the_error_message_as_on_channels_page(String string) {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.searchErrorMessage, 10);
    ...
    public void user_clicks_on_rows_per_page_dropdown() throws Throwable {
        ...
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.rows_dropdown, 10);
    ...
    public void user_selects_the_desired_number_from_rows_per_page_dropdown() throws Exception {
        SMSC_Actions.waitForElementToBeVisible(SMSC_Channels_PageObjects.rowsOption_dropdown, 10);
